...
class Paul(Actor):
    ...
    def get_open_adj_coords(self, coords):
        ...
        for i, coord in enumerate(all_adj):
            if(in_bounds[i]):
                costs.append(direction_cost[i] + self.world.get_terrain_cost(coord))
